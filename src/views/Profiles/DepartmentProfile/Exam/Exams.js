...
const promise1 = ()=>get_active_Subjects_prog_promise(
  ...
  return (
    ...
    <AddExam subjects={subjects} refetch={refetchExams} program={programs.filter((p)=>p.id===selectedProgram)[0]} modules={modules} committes={committes} edit={true} initialValues={exam}/>
