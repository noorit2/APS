  ...
  const isMediumScreen = useMediaQuery(theme.breakpoints.between('md', 'lg'));
    ...
    return(
        <Box sx={{width:"100%",display:"grid",justifyItems:"center",boxSizing:"border-box"}}>
            ...
            <InfoCards loading={loading} assesments={assements} attendancePercentage={attendancePercentage} lstWeekAttendPer={lstWeekAttendPer} assginments={assginments} noModules={studentModule.length}/>
