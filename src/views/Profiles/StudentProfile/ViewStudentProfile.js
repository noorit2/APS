    ...
    useEffect(() => {
        ...
        const f = async () => {
          try {
            ...
            console.log(p[0]);
            let pro={     firstname: p[0]?.firstname ? p[0].firstname : "",
            lastname: p[0]?.lastname?p[0].lastname:"",
            departmentName:p[0]?.departmentName?p[0].departmentName:"",
            number:p[0]?.number?p[0].number:"",
            username:  p[0]?.username ?  p[0].username: "",
            email: p[0]?.email ? p[0].email : "",
            profilePicture: p[0]?.profilePicture ? p[0].profilePicture : "",
            University_id: p[0]?.University_id? p[0].University_id:"",
            College_id: p[0]?.College_id?p[0].College_id:"",
            level:  p[0]?.level?  +p[0].level:"",
            Department_id: p[0]?.Department_id?p[0].Department_id:"",
            sex: p[0]?.sex?p[0].sex:"",
            program: p[0]?.program?p[0].program:"",
            registerdModules: p[0]?.registerdModules ? p[0].registerdModules:[],
            secondTryModules: p[0]?.secondTryModules?p[0].secondTryModules:[],
            failedModules: p[0]?.failedModules?p[0].failedModules:[],
            passedModules: p[0]?.passedModules?p[0].passedModules:[],}
            setprofile(pro);
        ...
        subheader={`@${profile.username}`}/>
            <CardContent sx={{display:"flex",width:"100%",justifyContent:isSmallScreen?"center":"flex-start",flexDirection:"row",flexWrap:"wrap"}}>
                ...
                <List sx={{width:"32%",minWidth:"150px",}}>
                    ...
                    <ListItem>
                        <ListItemText primary="Student number" secondary={profile.number || "-"}/>
                    </ListItem>
                    <ListItem>
