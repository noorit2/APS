...
import { get_posts_promise } from "../../../../utils/getandset.js";
...
const CollegeProfile = () => {
  ...
  const {data:departments,load,error}=useFetch(profile?.Department_id?profile.Department_id:[],reload);
  ...
  return (
    ...
    <AddDepartment setreload={setreload} showAddDepartment={setShowAddDepartment}/>
    </div>}
    {showAddDepartment && (
        <div
